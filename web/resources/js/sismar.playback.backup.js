...
Sismar.playback = function () {
    ...
    addControlsMap = function () {
        ...
        var backButton = L.Control.extend({
            ...
            onAdd: function () {
                ...
                container.onclick = function () {
                    window.location.href = "ais.xhtml";
                };
    ...
    getOverlayLayer = function () {
        var overlayLayer = [getNauticalChartLayer(), getInfoVesselsLayer(), getTypeVesselsLayer()];
        return overlayLayer;
    };
    ...
    this.loadPlaybackAis = function () {
        ...
        if (start !== null && end !== null) {
            var startDateMilliseconds = new Date(start).getTime();
            var endDateMilliseconds = new Date(end).getTime();

            var m1 = moment(endDateMilliseconds);
            var m2 = moment(startDateMilliseconds);
            $("#form-open-period-playback input[name='start']").val(m2.format('YYYY-MM-DDTH:mm'));
            $("#form-open-period-playback input[name='end']").val(m1.format('YYYY-MM-DDTH:mm'));
