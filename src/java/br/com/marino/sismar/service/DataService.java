...
public class DataService {
    ...
    public static List<ResponseDataDeviceDTO> getDataByDeviceId(long deviceId) {
        ...
        String response = Unirest
                .get(REST_API + "/v1/data/device/" + deviceId)
                .asString().getBody();

        try {
            System.out.println(response);
            return objectMapper.readValue(response, new TypeReference<List<ResponseDataDeviceDTO>>(){});
